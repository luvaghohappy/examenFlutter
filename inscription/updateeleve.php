...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE eleve SET matricule = '$matricule', nom ='$nom', postnom='$postnom', prenom='$prenom', classe='$classe', section='$section', options='$option', AnneScolaire='$annee' WHERE id = '$id'";
